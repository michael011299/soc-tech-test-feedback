...
// does this display the correct items in the console?

//Ticket 2: Traversing the DOM
let listItem = document.querySelector(".list-item");
console.log(listItem.parentNode);

// Date doesn't seem to appear in the list

// Ticket 2b
let itemList = document.getElementById("itemList");

//considering using a different variable name here
let childNodes = itemList.childNodes;
console.log(childNodes);

// Ticket 2c

//same as comment for 2b
...
// really good finding it dynamically, not always going to know the position of what you're looking for in the wild
...
function removeElementIfDate(element) {
  if (element.innerHTML === "🍇 Date") {
    // would also work with textContent instead of innerHTML
...
/* 
feedback - Team A
+ good use of comments to seperate out work
+ also good use of comments to explain workings/what code is intending to do
- it is linked but there is no initial check at the top like in the instructions
